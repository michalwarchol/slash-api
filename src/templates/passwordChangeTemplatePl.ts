export const title = 'Zmiana hasła w serwisie Slash';
...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Cześć ${userName}</p>
            <p>Aby dokończyć zmianę hasła, użyj poniższego kodu:</p>
            <div class="code">${code}</div>
            <p>Ten kod jest ważny przez następne 5 minut.</p>
        </div>
        <div class="footer">
            <p>&copy; ${new Date().getFullYear()} S/ash. Wszelkie prawa zastrzeżone.</p>
        </div>
    </div>
</body>
</html>
